...
namespace DatabaseConnectionExample
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string targetConnectionString = "your_spostgre_connection_string";
            ...
            {
                if ( //kvp.Key != "tbl_stok_depo_miktar" && kvp.Key != "tbl_001_grup_rehber" && kvp.Key != "tbl_001_rehber" && kvp.Key != "tbl_pot_is_amac" && kvp.Key != "tbl_stokkart_brm" && kvp.Key != "tbl_001_muhdet" && kvp.Key != "tbl_stok_barkod" && kvp.Key != "tbl_stok" && //BUYUK TABLE'LAR
                    ...
                    kvp.Key != "tbl_potansiyel_isler" && kvp.Key != "tbl_kampanya_master" && kvp.Key != "tbl_finans_turler" && kvp.Key != "tbl_potansiyel_isler_det" && kvp.Key != "tbl_kampanya_detay" && 
                    kvp.Key != "tbl_paylasim_dosya")
                /*&& kvp.Key != "tbl_017_muh_banka" && kvp.Key != "tbl_015_muh_cari" && kvp.Key != "tbl_018_muh_proje"*/
                //         && kvp.Key != "tbl_015_muh_banka" ) // && kvp.Key != "tbl_paylasim_dosya" 
                {

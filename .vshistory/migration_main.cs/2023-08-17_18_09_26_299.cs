...
namespace DatabaseConnectionExample
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            string outputFilePath = "C:\\Users\\mtddo\\Desktop\\cikti.txt"; //a_test //ciktisql //ciktisqlv2      ciktisql_3      ciktisql_4
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                ...
                {
                    sw.Write("Bağlantı hatası: " + ex.Message);

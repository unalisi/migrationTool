...
namespace DatabaseConnectionExample
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                if (kvp.Key != "tbl_stok_depo_miktar" && kvp.Key != "tbl_001_grup_rehber" && kvp.Key != "tbl_001_rehber" && kvp.Key != "tbl_pot_is_amac" && kvp.Key != "tbl_stokkart_brm" && kvp.Key != "tbl_001_muhdet" && kvp.Key != "tbl_stok_barkod"
                ...
                //         && kvp.Key != "tbl_015_muh_banka"
                //         && kvp.Key != "tbl_015_muh_banka"
                //         && kvp.Key != "tbl_015_muh_banka" ) // && kvp.Key != "tbl_stok_barkod" tbl_stok
                {

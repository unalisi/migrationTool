    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            foreach (var kvp in columnNames)
            {
                ...
                //        kvp.Key != "tbl_per_izintip" && kvp.Key != "tbl_017_muh_stok" && kvp.Key != "tbl_015_muh_kasa" && kvp.Key != "tbl_001_firma_tur" /*&& kvp.Key != "tbl_001_meslek"*/ &&
                //        kvp.Key != "tbl_001_meslek") // && kvp.Key != "tbl_001_meslek"
                {

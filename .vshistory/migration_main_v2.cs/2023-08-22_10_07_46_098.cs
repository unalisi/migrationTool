...
namespace DatabaseConnectionExample
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                if (kvp.Key != "tbl_stok_depo_miktar" && kvp.Key != "api_test" && kvp.Key != "_ana_tablo" && kvp.Key != "_ana2" && kvp.Key != "tbl_uts_ulkeler" &&
                    ...
                    kvp.Key != "tbl_vkn_cari" && kvp.Key != "tbl_kisayol_menu_bilgi" && kvp.Key != "_voltaj" && kvp.Key != "tbl_pot_is_drm" && kvp.Key != "tbl_pot_is_grp")
                ...
                //         && kvp.Key != "tbl_015_muh_banka"
                //         && kvp.Key != "tbl_015_muh_banka"
                //         && kvp.Key != "tbl_015_muh_banka" ) // && kvp.Key != "tbl_pot_is_grp"
                {

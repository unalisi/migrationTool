...
namespace DatabaseConnectionExample
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            {
                if (kvp.Key != "tbl_017_muh_banka" && kvp.Key != "tbl_015_muh_cari" && kvp.Key != "tbl_018_muh_proje" && kvp.Key != "tbl_parametreler" && 
                    kvp.Key != "tbl_per_izintip") // && kvp.Key != "tbl_per_izintip"
                {

        ...
        static void Main(string[] args)
        {
            ...
            foreach (var kvp in columnNames)
            {
                if (kvp.Key != "tbl_stok_depo_miktar" && kvp.Key != "api_test" && kvp.Key != "_ana_tablo" && kvp.Key != "_ana2" && kvp.Key != "tbl_uts_ulkeler" &&
                    kvp.Key != "tbl_efatura_brm" && kvp.Key != "tbl_001_grup_1622" && kvp.Key != "tbl_hayvan_yonetimi" && kvp.Key != "tbl_gib_earsiv_fat")
                ...
                //         && kvp.Key != "tbl_015_muh_banka"
                //         && kvp.Key != "tbl_015_muh_banka"
                //         && kvp.Key != "tbl_015_muh_banka" ) // && kvp.Key != "tbl_gib_earsiv_fat"
                {
